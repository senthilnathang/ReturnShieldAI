      ...
      <section className="space-y-4 rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-2 text-sm text-slate-600">Upload a picture now. OCR and fraud analysis will run after the return is submitted.</div>
          </div>
          <button
            type="button"
        ...
        {imagePreview ? (
          <div className="grid gap-4 xl:grid-cols-[240px_1fr]">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
              ...
              <div className="mt-2 text-sm font-medium text-slate-900">{imageName ?? 'Return evidence image'}</div>
              <div className="mt-2">The backend will compare this image after submission and attach the OCR trail to the return record.</div>
            </div>
          </div>
        ) : (
          <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-5 text-sm text-slate-600">
            No image uploaded yet. You can still create the return and add evidence later.
          </div>
        )}
      </section>
